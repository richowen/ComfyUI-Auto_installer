...
git clone https://github.com/alexopus/ComfyUI-Image-Saver "$customNodesPath/ComfyUI-Image-Saver" >> "$logFile" 2>&1
"$PIP" install -r "$customNodesPath/ComfyUI-Image-Saver/requirements.txt" --no-warn-script-location >> "$logFile" 2>&1

echo "  - ComfyUI_UltimateSDUpscale"
git clone https://github.com/ssitu/ComfyUI_UltimateSDUpscale "$customNodesPath/ComfyUI_UltimateSDUpscale" >> "$logFile" 2>&1
